      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="hidden md:flex items-center space-x-2 bg-red-50 text-red-700 px-3 py-2 rounded-lg border border-red-200">
              <Phone size={16} />
              <span className="text-sm font-semibold">24/7: +370 600 99999</span>
            </div>

            {/* Search */}
            <button className="p-2 text-gray-600 hover:text-teal-600 hover:bg-teal-50 rounded-lg transition-all duration-300 transform hover:scale-110">
              <Search size={20} />
            </button>

            {/* Language Selector */}
            <div className="relative group">
              <button className="flex items-center space-x-2 px-3 py-2 text-gray-600 hover:text-teal-600 hover:bg-teal-50 rounded-lg transition-all duration-300">
                <Globe size={18} />
        ...
        <div className={`lg:hidden transition-all duration-300 overflow-hidden ${
          ...
          <nav className="bg-white rounded-xl shadow-xl p-4 space-y-2 border border-gray-100">
            <Link to="/" className="block py-3 px-4 text-gray-700 hover:bg-teal-50 hover:text-teal-600 rounded-lg transition-colors duration-200 font-medium">
              Pradžia
            </Link>
            <Link to="/tours" className="block py-3 px-4 text-gray-700 hover:bg-teal-50 hover:text-teal-600 rounded-lg transition-colors duration-200 font-medium">
              Kelionės
            </Link>
            <Link to="/destinations" className="block py-3 px-4 text-gray-700 hover:bg-teal-50 hover:text-teal-600 rounded-lg transition-colors duration-200 font-medium">
              Populiarios kryptys
            </Link>
            <Link to="/gallery" className="block py-3 px-4 text-gray-700 hover:bg-teal-50 hover:text-teal-600 rounded-lg transition-colors duration-200 font-medium">
              Galerija
            </Link>
            <Link to="/reviews" className="block py-3 px-4 text-gray-700 hover:bg-teal-50 hover:text-teal-600 rounded-lg transition-colors duration-200 font-medium">
              Atsiliepimai
            </Link>
            <Link to="/about" className="block py-3 px-4 text-gray-700 hover:bg-teal-50 hover:text-teal-600 rounded-lg transition-colors duration-200 font-medium">
              Apie mus
            </Link>
            <Link to="/contact" className="block py-3 px-4 text-gray-700 hover:bg-teal-50 hover:text-teal-600 rounded-lg transition-colors duration-200 font-medium">
              Kontaktai
            </Link>
          </nav>
        </div>
